...
# 翻訳処理(日本語->英語)：翻訳精度が悪い、Google翻訳を介した方が感情分析の精度は高い
        ...
        if(language == 'ja'):
            ...
            language_translator = LanguageTranslatorV3(
                    version='2018-05-01',
                    iam_apikey='YRH0vpBeJhjmqAKNeR2OqSlPGlZMgIVi8cRjs1L4doPS',
...
# 感情分析
        ...
        tone = tone_analyzer.tone({"text": text},content_type=content_type).get_result()
        ...
        return render_template('watson/watson.html', messages=messages)
